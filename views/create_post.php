        ...
        <div class="row justify-content-around">
            ...
            <div class="col-12">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" id="post">
                    ...
                    <input class="post_title" aria-label="Title" id="tile" name="title" type="text" placeholder="Title"
                           form="post">
                    ...
                    <?php foreach ($categories as $single_category) { ?>
                        ...
                        <input type="radio" id="<?= $single_category['category'] ?>" name="category_id"
                               value="<?= $single_category['category_id'] ?>" form="post">
                    ...
                    <button type="submit" id="publish" value="1" name="published" class="btn btn-primary post"
                            form="post">Post
                    </button>
                </form>
            </div>
